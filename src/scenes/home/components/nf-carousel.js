    ...
    <div>
      <div className="row nf-carousel-slider">
        ...
        {props.data.page === 0 && props.data.index === 0 ?
          null : <i className="fa fa-2x fa-angle-right fa-rotate-180 nf-carousel-toggle nf-carousel-button-wrapper"
                    aria-hidden="true" onClick={props.getPrevious}/>
        }
        ...
        <i className="fa fa-2x fa-angle-right nf-carousel-toggle nf-carousel-button-wrapper" aria-hidden="true"
